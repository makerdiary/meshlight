...
C_SOURCE_FILES += $(COMPONENTS)/drivers_nrf/ppi/nrf_drv_ppi.c
C_SOURCE_FILES += $(COMPONENTS)/drivers_nrf/timer/nrf_drv_timer.c
C_SOURCE_FILES += $(COMPONENTS)/drivers_nrf/nrf_soc_nosd/nrf_soc.c
